...
public class CaptionTv extends Tv { // 'extends Tv'는 Tv 클래스를 상속받는다는 의미입니다.
                                     // 즉, CaptionTv는 Tv가 가진 모든 변수(color, channel, power 등)와
                                     // 메서드(power(), channelUp(), channelDown() 등)를 사용할 수 있습니다.

	boolean caption; // 캡션 기능의 상태를 나타내는 필드입니다.
	                 // true면 캡션이 켜진 상태, false면 꺼진 상태를 의미합니다.
	                 // 이 필드는 부모 클래스인 'Tv'에는 없고, 'CaptionTv'에만 **추가된** 새로운 기능입니다.
